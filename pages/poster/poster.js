...
Page({
  data: {
    ...
    wishname: "圣诞节心愿契约圣诞节心愿契约圣诞节心愿契约圣诞节心愿契约",
    wishinfo:
      "望契约描述契约愿描述契约描述契约描述契约描述契约契约描述契约描述契约描述契约描述契约描述契约描述望愿描述契约描述契约描述契约描述契约契约描述契约描述契约描述契约描述契约描述契约描述望愿描述契约描述契约描述契约描述契约契约描述契约描述契约描述契约描述契约描述契约描述望愿描述契约描述契约描述契约描述契约契约描述契约描述契约描述契约描述契约描述契约描述望愿描述契约描述契约描述契约描述契约契约描述契约描述契约描述契约描述契约描述契约描述"
  },
  onPosterSuccess(e) {
    const { detail } = e;
    PosterData = detail;
